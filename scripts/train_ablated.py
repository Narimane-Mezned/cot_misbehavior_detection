...
def main():
    config_path = REPO_ROOT / "configs" / "pampos_ablated.yaml"
    ...
    print(f"[setup] Ablated feature set: {names}")
    print(f"[setup] Dropped: point_count, is_camera_visible, distance_to_ego")
    ...
    stats_path = processed_dir / "feature_stats_ablated.npz"
    ...
    checkpoint_path = checkpoint_dir / "pampos_ablated_best.pt"
    ...
    print(f"[done] Compare against pampos_baseline_best.pt, which saw the same windows")
    print(f"[done] with all eight features.")
